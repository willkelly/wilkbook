...
| reader | `pinenote/systems/pinenote-reader.scm` | usb-console plus the cage+KOReader Wayland kiosk (`reader-session` Shepherd service; `doc/koreader-spike.md`). The reading-first target; not yet hardware-validated. |
