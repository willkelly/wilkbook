...
;;;
;;; This file is an exact source successor to the accepted
;;; book-execution-spike/oci-book-bundle.scm.  Its only executable-policy delta
;;; is the explicit Python -S below: the frozen joined Python book was accepted
;;; under -I -S, and this guest must preserve that no-site path while retaining
;;; every accepted CONTROL/runsc, mount, closure, and FD-donation decision.
