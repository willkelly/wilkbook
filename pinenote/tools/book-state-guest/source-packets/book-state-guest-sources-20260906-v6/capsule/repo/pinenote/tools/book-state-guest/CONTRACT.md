...
boundary. The independently replayed v4 source successor closed BSG-3's
incomplete frozen module view, but its SQLite-absence statement was false. This
v5 successor preserves that capsule boundary, states the actual 45-path closure,
and adds runtime storage-denial probes for independent review before any image
construction.
...
- Candidate repository baseline: `399764fa53d4e54bdcfaf84c362d4d1debf35f4c`.
  ...
  source base `549dded816e5f73d2c11557ffcd3130a018b82a8`; v5 does not rewrite it.
...
execute the probes, runsc, ARM code, QEMU, networking, hardware, or a device.
