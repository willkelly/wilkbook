...
def main() -> None:
    ...
    check(
        ...
        in system
        and "guest-source-successor=v8-completed-book-result-boundary-correlation"
        in system
        ...
        "v8 names the current candidate baseline without rewriting prerequisite history",
    )
    check(
