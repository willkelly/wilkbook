...
;;; BEGIN V7 FINISHED-CAPTURE SANDBOX-BOUNDARY RELAY
...
(define* (validate-and-publish-sandbox-boundary!
          language container-id bundle child result
...
;;; END V7 FINISHED-CAPTURE SANDBOX-BOUNDARY RELAY
       ...
       (catch #t
         (lambda ()
           ...
           (validate-and-publish-sandbox-boundary!
            ...
            (peer-value peer 'protocol-peer-child) result)
