...
;;; The lifecycle implementation is unchanged.  Three optional integration hooks
;;; let the Book State seam validate one inherited FD immediately before exec and
;;; record the exact guardian/direct-child identities without PID/name scans.
