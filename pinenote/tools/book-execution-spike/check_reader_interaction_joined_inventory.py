...
CURRENT_ROSTER = BUILD / "reader-interaction-guest-outer-frozen-inputs-v2.txt"
...
EXTRA_JOINED = (
    (
        "369cb397e36ff72e95975252c872856e24ecd5508e6476d7d07de2be34c26780",
...
EXPECTED_HEADERS = (
    ...
    "status=frozen-both-independent-source-conditions-accepted",
    "path-count=46",
    ...
    "outer-core-source-edit=none",
    "accepted-coordinator-binding=joined-inventory-and-test-only-private-roster",
