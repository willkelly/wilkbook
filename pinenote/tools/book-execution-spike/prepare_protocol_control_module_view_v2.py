#!/usr/bin/env python3
"""Versioned v2 view for the reviewed null-netns protocol successor."""
...
MODULE_VIEW = HERE / "build/protocol-control-guix-module-view-v2"
PACKAGE_DISCOVERY_VIEW = HERE / "build/protocol-control-guix-package-view-v2"
PROTOCOL_SYSTEM = "pinenote/systems/pinenote-book-execution-protocol-control.scm"
PROTOCOL_SYSTEM_SHA256 = (
    "fb1b55ba664342852baa34a65ae7f18a1fc1cf7a524a2e5571a2169ed6874c90"
)
...
def main(argv: list[str]) -> int:
    if argv == ["create"]:
        ...
        raise base.ModuleViewError(
            "usage: prepare_protocol_control_module_view_v2.py "
